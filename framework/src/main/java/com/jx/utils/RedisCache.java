...
public class RedisCache
{
     ...
     * @return
     */
    public boolean isMember(String setKey,String id){
        return redisTemplate.opsForSet().isMember(setKey, id);
    }
    public void decrementCount(String key,Long number){
        redisTemplate.boundValueOps(key).decrement(number);
    }
    public void addCount(String key,Long number){
        redisTemplate.opsForValue().increment(key, number);
    }
    public void addMember(String setKey,String key){
        redisTemplate.opsForSet().add(setKey, key);
    }
    public void deleteMember(String setKey,String key){
